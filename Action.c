...
/*Correlation comment - Do not change!  Original value='130987.090319968zHDHztiptfiDDDDDtAtcfpiQAHf' Name ='userSession' Type ='ResponseBased'*/
...
//	lr_output_message(lr_eval_string("{city}"));
//	lr_output_message(lr_eval_string("{city2}"));
//
//	lr_end_transaction("first_transaction", LR_AUTO);
//
//	pi = 3;
//	lr_output_message("%d", pi);
//	lr_save_string("Los Santos", "param");
//
//
...
//
	...
	web_submit_data("reservations.pl_2", 
		...
		"Mode=HTML", 
		ITEMDATA, 
		"Name=outboundFlight", "Value={bilet}", ENDITEM, 
		"Name=numPassengers", "Value=1", ENDITEM, 
		"Name=advanceDiscount", "Value=0", ENDITEM, 
		"Name=seatType", "Value=Coach", ENDITEM, 
		"Name=seatPref", "Value=None", ENDITEM, 
